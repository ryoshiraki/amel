...
impl SamplerBuilder {
    ...
    pub const DEFAULT_MAG_FILTER: wgpu::FilterMode = wgpu::FilterMode::Nearest;
    pub const DEFAULT_MIN_FILTER: wgpu::FilterMode = wgpu::FilterMode::Nearest;
    ...
    pub const DEFAULT_LABEL: &'static str = "sampler";
...
impl From<SamplerBuilder> for wgpu::SamplerDescriptor<'static> {
    fn from(builder: SamplerBuilder) -> Self {
        builder.descriptor
    }
}
